            ...
            <div class="card modern-card border-0 shadow-lg overflow-hidden">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="category-section mb-5">
                        ...
                        <form method="GET" action="{{ route('chairperson.upload_files') }}" class="category-form">
                    ...
                    <div class="details-section">
                        <div class="section-header mb-4">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('chairperson.upload_files') }}" class="btn btn-outline-secondary btn-sm">
                                    <i class="fas fa-exchange-alt me-1"></i> Change Category
                                </a>
                            </div>
                        </div>
                        
                        <form method="POST" action="{{ route('chairperson.upload.document') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
