    ...
    <div class="row mb-4">
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('chairperson.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('chairperson.archived_files') }}">Archived Files</a></li>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('chairperson.archived_files') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row g-2 mt-4">
                                <div class="col-md-4">
                                    <a href="{{ route('chairperson.download-archive-file', $file->id) }}" 
                                ...
                                @if(in_array($file->file_type, ['pdf', 'jpg', 'jpeg', 'png', 'txt']))
                                    <div class="col-md-4">
                                        <a href="{{ route('chairperson.view-file', $file->id) }}" 
                                            target="_blank"
