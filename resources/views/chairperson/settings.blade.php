        ...
        <div class="col-12">
            <div class="page-header d-flex align-items-center justify-content-between">
                ...
                <div class="badge bg-light text-dark border">
                    <i class="bi bi-shield-check me-2"></i>Chairperson Account
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25">
                                <i class="bi bi-award me-1"></i>Chairperson
                            </span>
                        </div>
                    </div>

                    <form action="{{ route('chairperson.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3">
                            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="username" class="form-control border-start-0 border-top-0 border-end-0 rounded-0 px-0" 
        ...
        <div class="col-xl-4">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('chairperson.profile.password') }}" method="POST">
                        @csrf
                        <div class="mb-3">
