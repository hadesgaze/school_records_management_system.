...
<head>
    ...
    <title>@yield('page-title', 'Chairperson - Document Management System')</title>
        ...
        <nav class="flex-1 px-4 py-6 overflow-y-auto custom-scrollbar">
            <ul class="space-y-2">
                <li>
                    ...
                    {{ request()->routeIs('chairperson.dashboard') ? 'active-menu shadow-md' : 'text-gray-600 hover:bg-gray-50 hover:text-blue-700' }}">
                        <span class="material-icons mr-3 text-xl {{ !request()->routeIs('chairperson.dashboard') ? 'text-gray-400 group-hover:text-blue-700' : '' }}">dashboard</span> 
                        Dashboard
                    </a>
                </li>
                
                <li>
                    <a href="{{ route('chairperson.upload_files') }}"
                    class="flex items-center px-4 py-3 rounded-lg font-medium transition duration-200 group
                    {{ request()->routeIs('chairperson.upload_files') ? 'active-menu shadow-md' : 'text-gray-600 hover:bg-gray-50 hover:text-blue-700' }}">
                        <span class="material-icons mr-3 text-xl {{ !request()->routeIs('chairperson.upload_files') ? 'text-gray-400 group-hover:text-blue-700' : '' }}">upload</span> 
                        Upload Files
                    </a>
                </li>
                
                <li>
                    <a href="{{ route('chairperson.archived_files') }}"
                    class="flex items-center px-4 py-3 rounded-lg font-medium transition duration-200 group
                    {{ request()->routeIs('chairperson.archived_files') ? 'active-menu shadow-md' : 'text-gray-600 hover:bg-gray-50 hover:text-blue-700' }}">
                        <span class="material-icons mr-3 text-xl {{ !request()->routeIs('chairperson.archived_files') ? 'text-gray-400 group-hover:text-blue-700' : '' }}">folder_open</span> 
                        Archived Files
                    </a>
                </li>
            </ul>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="dropdown relative">
                    ...
                    <div id="userDropdown" class="hidden absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50">
                        ...
                        <a href="{{ route('chairperson.settings') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50 text-sm transition-colors">
