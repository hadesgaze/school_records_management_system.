    ...
    <div class="row mb-4">
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dean.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('dean.archived_files') }}">Archived Files</a></li>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('dean.archived_files') }}" class="btn btn-outline-secondary">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row g-2 mt-4">
                                ...
                                @if(in_array($file->file_type, ['pdf', 'jpg', 'jpeg', 'png', 'txt']))
                                    <div class="col-md-4">
                                        <a href="{{ route('dean.view-file', $file->id) }}" 
                                            target="_blank"
